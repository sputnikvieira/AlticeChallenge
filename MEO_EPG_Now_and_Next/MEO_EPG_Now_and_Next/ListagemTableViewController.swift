...
class ListagemTableViewController: UITableViewController {
    ...
    private var epgNowAndNext: EpgNowAndNext?
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            if epgNowAndNext != nil{
              formattedString = self.epgNowAndNext!.nowShow.replacingOccurrences(of: " ", with: "+")
...
//              fetchImg(formattedString: urlFinal, callLetter: self.channelList[indexPath.row].callLetter)
            ...
            cell.nowProgramChannel.text = self.epgNowAndNext?.nowShow
            cell.nextProgramChannel.text = self.epgNowAndNext?.nextShow
